...
* [June X](week1-introtodocker.html) **Introduction to Docker for R users** I will introduce you to using Docker to run R and RStudio in containers. [Lecture notes](week1-introtodocker.html)
<!-- - [Lecture video](https://youtu.be/M1sOC4046PQ) - [Q&A](week1.html) -->

* [June X](week2-github.html) **More Git skills + GitHub issues, organizations, and releases** This week, I'll cover the basics of reverting changes and using Git branches. Then we'll learn about key GitHub tools for managing your work and collaborating: issues, discussion threads, wikis, organizations and releases. These features are key to helping you organize your work and keep track of what needs to be done. These features also allow a team to collaborate effectively together on a repository. Next week, we'll start learning about GitHub project boards. [Lecture notes](week2-github.html) - [Lecture video](https://youtu.be/NrHTf-TF_7A) - [Q&A](week2.html)
